...
export default function Projects() {
  return (
    <div className="bg-[#f7f9fb] text-[#191c1e] selection:bg-[#d5e3fd] selection:text-[#57657b] min-h-screen overflow-x-hidden">
      ...
      <main className="pt-16 overflow-x-hidden">
        ...
        <section className="relative min-h-[716px] flex items-center bg-[#f7f9fb] pt-20 pb-24 md:pb-32 px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-8 lg:col-span-7">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-[#182034] leading-[1.1] mb-8">
                Policy Briefs & Academic Research
              </h1>
              <p className="text-lg md:text-xl text-[#43474e] max-w-2xl leading-relaxed mb-10">
            ...
            <div className="hidden md:block md:col-span-4 lg:col-span-5 relative h-full">
              ...
              <div className="relative z-10 p-8 bg-[#ffffff] rounded-xl border-t-4 border-[#3b1600] shadow-xl shadow-[#182034]/5 rotate-2 translate-y-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#182034] flex items-center justify-center text-[#ffffff]">
                    <span className="material-symbols-outlined text-lg">policy</span>
                  </div>
                  <span className="text-xs font-bold tracking-widest uppercase text-[#43474e]">Active Directive</span>
                </div>
                <p className="text-sm font-medium text-[#182034] italic mb-4">"Frameworks must be as resilient as the communities they serve."</p>
                <div className="space-y-2">
                  <div className="h-1.5 w-full bg-[#e6e8ea] rounded-full overflow-hidden">
        ...
        <section className="bg-[#f2f4f6] py-24 md:py-32 px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              <div className="max-w-xl">
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter text-[#182034] mb-4">Case Studies & Policy Briefs</h2>
                <p className="text-[#43474e] font-medium">Investigating the intersection of emerging technology and urban equity through data-driven advocacy.</p>
              </div>
              <div className="flex gap-2">
                <button className="p-2 border border-[#c4c6cf] hover:border-[#182034] rounded-sm transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
              {/* Card 1 */}
              <div className="group flex flex-col bg-[#ffffff] overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-[#182034]/5">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    ...
                    <span className="px-2 py-1 bg-[#e0e3e5] text-[#182034] text-[0.6rem] font-bold tracking-widest uppercase rounded-sm">Algorithmic Governance</span>
                  </div>
                </div>
                <div className="p-8 flex flex-col h-full border-t-4 border-[#3b1600]">
                  <h3 className="text-2xl font-extrabold tracking-tight text-[#182034] mb-4 leading-tight">Algorithmic Rent-Setting & Housing Equity</h3>
                  <p className="text-[#43474e] leading-relaxed mb-8 flex-grow">
                  ...
                  <Link className="inline-flex items-center gap-2 text-sm font-bold tracking-widest uppercase text-[#182034] hover:gap-4 transition-all" href="#">
              ...
              <div className="group flex flex-col bg-[#ffffff] overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-[#182034]/5">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    ...
                    <span className="px-2 py-1 bg-[#e0e3e5] text-[#182034] text-[0.6rem] font-bold tracking-widest uppercase rounded-sm">Program Evaluation</span>
                  </div>
                </div>
                <div className="p-8 flex flex-col h-full border-t-4 border-[#3b1600]">
                  <h3 className="text-2xl font-extrabold tracking-tight text-[#182034] mb-4 leading-tight">Evaluating Community-Based Safety Ambassadors</h3>
                  <p className="text-[#43474e] leading-relaxed mb-8 flex-grow">
        ...
        <section className="py-24 md:py-32 overflow-hidden bg-[#f7f9fb]">
          <div className="max-w-7xl mx-auto px-8 mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter text-[#182034]">Presentations & Engagements</h2>
          </div>
          ...
          <div className="flex overflow-x-auto gap-8 px-8 md:px-[calc((100vw-80rem)/2+2rem)] hide-scrollbar snap-x snap-mandatory">
            ...
            <div className="flex-none w-[85vw] md:w-[600px] snap-center">
              <div className="bg-[#e6e8ea] p-8 md:p-12 rounded-xl relative overflow-hidden group">
                ...
                <h3 className="text-3xl font-extrabold tracking-tight text-[#182034] mb-6">Combating Health Misinformation in Local Communities</h3>
                <div className="flex items-center gap-2 mb-6 text-[#43474e]">
                  <span className="material-symbols-outlined text-lg">groups</span>
                  <span className="text-sm font-bold uppercase tracking-wider">Target: Rhode Island Public Health Association</span>
                </div>
                <p className="text-[#43474e] leading-relaxed text-lg mb-8">
                ...
                <div className="flex items-center gap-4 cursor-pointer hover:opacity-80 transition-opacity">
                  <div className="w-12 h-12 bg-[#ffffff] rounded-full flex items-center justify-center border border-[#c4c6cf]">
                    <span className="material-symbols-outlined text-[#182034]">play_circle</span>
                  </div>
                  <span className="text-xs font-bold tracking-widest uppercase text-[#182034]">View Full Slideshow</span>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#f2f4f6] py-24 md:py-32 px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter text-[#182034] mb-4">Technical & AI Toolkit</h2>
              <p className="text-[#43474e] max-w-2xl mx-auto font-medium">The architectural stack behind my research and policy modeling processes.</p>
            </div>
            
            <div className="space-y-16">
              {/* Category 1 */}
              <div>
                <h4 className="text-xs font-bold tracking-[0.2em] uppercase text-[#43474e] mb-8 border-b border-[#c4c6cf]/30 pb-2">Data & Systems Architecture</h4>
                <div className="flex flex-wrap gap-3">
                  {['Python', 'SQL', 'Tableau', 'JSON', 'MATLAB', 'AutoCAD', 'Microsoft Project', 'RecDesk', 'Gradescope'].map(tech => (
                    <span key={tech} className="px-5 py-2.5 bg-[#ffffff] text-[#182034] text-xs font-bold uppercase tracking-wider rounded-full shadow-sm hover:bg-[#182034] hover:text-[#ffffff] transition-all cursor-default">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              {/* Category 2 */}
              <div>
                <h4 className="text-xs font-bold tracking-[0.2em] uppercase text-[#43474e] mb-8 border-b border-[#c4c6cf]/30 pb-2">AI & Generative Workflows</h4>
                <div className="flex flex-wrap gap-3">
        ...
        <section className="py-24 px-8 bg-[#182034] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4">
              ...
              <button className="px-8 py-4 border border-[#ffffff]/30 text-[#ffffff] text-sm font-bold tracking-widest uppercase rounded-md hover:bg-[#ffffff]/10 transition-all">
