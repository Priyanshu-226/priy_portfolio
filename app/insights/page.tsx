      ...
      <main className="pt-32 pb-24 px-8 max-w-7xl mx-auto">
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Article Card 1 */}
            <article className="group bg-[var(--surface-elevated)] flex flex-col h-full border-t-4 border-[#3b1600] p-8 transition-all hover:bg-[var(--surface)]">
              ...
              <h2 className="text-[var(--text-main)] text-xl font-bold leading-snug mb-4 group-hover:text-[#3b1600] transition-colors">The Impact of Algorithmic Rent-Setting on Housing Equity</h2>
            ...
            {/* Article Card 2 */}
            <article className="group bg-[var(--surface-elevated)] flex flex-col h-full border-t-4 border-[#f0813a] p-8 transition-all hover:bg-[var(--surface)]">
              <div className="flex justify-between items-start mb-6">
              ...
              <h2 className="text-[var(--text-main)] text-xl font-bold leading-snug mb-4 group-hover:text-[#f0813a] transition-colors">Frameworks for Combating Health Misinformation in Local Communities</h2>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-8 flex-grow">
            ...
            {/* Article Card 3 */}
            <article className="group bg-[var(--surface-elevated)] flex flex-col h-full border-t-4 border-[#182034] p-8 transition-all hover:bg-[var(--surface)]">
              <div className="flex justify-between items-start mb-6">
              ...
              <h2 className="text-[var(--text-main)] text-xl font-bold leading-snug mb-4 group-hover:text-[#2e354a] transition-colors">Human-in-the-Loop Pipelines for Educational Data</h2>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-8 flex-grow">
        ...
        <section className="mt-24">
          ...
          <div className="space-y-4">
            <Link className="group flex flex-col md:flex-row md:items-center justify-between p-6 bg-[var(--surface-elevated)] hover:bg-[var(--surface-2)] transition-all" href="#">
              ...
              <div className="flex items-center gap-8 mt-4 md:mt-0">
                ...
                <span className="material-symbols-outlined text-[var(--text-muted)] group-hover:text-[var(--text-main)] group-hover:translate-x-1 transition-all">arrow_outward</span>
              </div>
            </Link>
